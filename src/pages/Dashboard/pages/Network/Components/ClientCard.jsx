...
function ClientCard({ name, maxBandwidth, bandwidthLimit, isOnline }) {
  return (
    <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow text-xl text-stone-700 max-md:mt-10">
        ...
        <div className="flex flex-col pt-3.5 pb-10 rounded-3xl bg-slate-300">
          ...
          <div className="mt-10 mr-3.5 ml-3 max-md:mx-2.5">Max bandwidth : {maxBandwidth}</div>
          <div className="mt-4 mr-3 ml-3 max-md:mx-2.5">Bandwidth limit : {bandwidthLimit}</div>
        </div>
      </div>
    </div>
  );
